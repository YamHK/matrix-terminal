...
public class UserAgentUtils {
    ...
    public static String getOsVersion(String userAgent) {
        ...
        osVersion = strArr[1];
        log.warn("osVersion is:{}", osVersion);
        return osVersion;
    }
    ...
    public static String getDevicetype(String userAgent) {
        ...
        log.warn("deviceType is:{}", deviceType);
        return deviceType;
    }
    ...
    public static String getDeviceManufacturer(String userAgent) {
        ...
        log.warn("deviceManufacturer is:{}", deviceManufacturer);
    ...
    public static String getBorderName(String userAgent) {
        ...
        log.warn("borderName is:{}", borderName);
        return borderName;
    }
    ...
    public static String getBorderType(String userAgent) {
        ...
        log.warn("borderType is:{}", borderType);
        return borderType;
    }
    ...
    public static String getBorderGroup(String userAgent) {
        ...
        log.warn("browerGroup is:{}", browerGroup);
        return browerGroup;
    }
    ...
    public static String getBrowserManufacturer(String userAgent) {
        ...
        log.warn("browserManufacturer is:{}", browserManufacturer);
    ...
    public static String getBorderRenderingEngine(String userAgent) {
        ...
        log.warn("renderingEngine is:{}", renderingEngine);
